                            ...
                            <div className={"card p-2 mb-2  " + foodColor}>
                                <div className="row">
                                    ...
                                    <div className="col-8 pl-0 main-card-text">
                                        ...
                                        <div className="order-card-text">{item.descr}</div>
                                        <div className="quantity" style={{ fontWeight: "600" }}>{item.quantity}</div>
                                        {item.done===false?<div className="d-flex justify-content-end mt-2" style={{bottom:"0"}}><div id={"button" + newId} className="btn btn-check" style={{opacity:"0.5"}} >Preparing</div></div>:<div id={newId}  ><FontAwesomeIcon className="thumbsUp" style={{display:"inline",opacity:"0.5"}} icon={faThumbsUp}></FontAwesomeIcon></div>}
        ...
        <div className="col-12 ">
            <div className="card big-card p-4">
                <div className="row">
                    ...
                    <div className="col-4 text-right d-flex justify-content-end align-items-start nameCust"><span className="orderNumber mr-3  " style={{  whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{props.item["Customer-Name"]}<br /></span></div>
                </div>
                <div className="row">
                    {renderSmallCARDS()}
                </div>
